<?php /* Smarty version 2.3.1, created on 2005-11-12 22:18:17
         compiled from modern_blue/login.htm */ ?>
<?php $this->_load_plugins(array(
array('modifier', 'date_format', 'modern_blue/login.htm', 16, false),)); ?><?php $this->_config_load($this->_tpl_vars['umLanguageFile'], "Login", 'local'); ?>
<html>
<head>
...
<body text="#000000">
<table width="100%" height="100%"  border="00" cellpadding="0" cellspacing="0" bgcolor="#334163">
  <tr>
    <td height="551"><table width="100%"  border="00" cellpadding="0" cellspacing="0">
      <tr bgcolor="#334163">
        <td>&nbsp;</td>
        <td align="right"><span class="login_time"><?php echo $this->_run_mod_handler('date_format', true, time(), "%l:%M"); ?>
&nbsp;<?php if ($this->_run_mod_handler('date_format', true, time(), "%p") != "PM"): ?>am<?php else: ?>pm<?php endif; ?></span>&nbsp;&nbsp;&nbsp;<br><span class="login_bottom"><?php echo $this->_run_mod_handler('date_format', true, time(), "%A, %B %e, %Y"); ?>
</span>&nbsp;&nbsp;&nbsp;</td>
      </tr>
      <tr>
