...
?>   
  <tr>
    <td class="border">
      ...
      <tr>
       <td class="content2">Current File: <input type="text" class="textinput" value="<?php echo $sess_Data["dir"] . "/" . $file["name"] ?>" size=40 readonly></td>
   ...
   <form name="form_listing" method="post" action="crossover.php" enctype="multipart/form-data" TARGET="_top">
   <tr>
    <td class="content3"><textarea name="EDITOR" cols=<?php echo $personal["edit_col"] ?> rows=<?php echo $personal["edit_row"] ?> class="textinput2"><?php echo $file["content"] ?></textarea></td>
   </tr>
   <tr class="buttonBar">
    <td align="center" class="content2"><input name="submit" type="submit" class="button" value="Save"> | | <input name="submit" type="submit" class="button" value="Save & Edit"> | | <input name="submit" type="submit" class="button" value="Preview"> | | <input type="reset" class="button" value="Reset"></td>
   </tr>
   <input type=hidden name="FILE" value="<?php echo $file["name"] ?>">
   <input type=hidden name="SID" value="<?php echo $SID ?>">
   </form>
