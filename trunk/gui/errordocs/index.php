    ...
    <td height="551"><table width="100%"  border="00" cellpadding="0" cellspacing="0">
      <tr bgcolor="#334163">
        ...
        <td align="right"><span class="login_time"><?php print date("g:i a"); ?></span>&nbsp;&nbsp;&nbsp;<br>
          <span class="login_bottom"><?php print date("l dS of F Y"); ?></span>&nbsp;&nbsp;&nbsp;</td>
      </tr>
      <tr>
        ...
        <td height="348" align="center" background="/vhcs2/themes/modern_blue/images/login/content_background.gif">
		  <table width="600" height="200" border="00" cellpadding="1" cellspacing="3" bgcolor="#FF0000">
            <tr>
			  ...
			  <h2><font color="#FF0000">Error <?php print $_SERVER['REDIRECT_STATUS'];?>!</font></h2>
                <br/>
                <b><?php print $_SERVER['REDIRECT_URL'];?></b><br>
                <?php
