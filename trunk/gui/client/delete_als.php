...
SQL_QUERY;
  ...
  $query = "select count(mail_id) as cnt from mail_users WHERE sub_id = ?";
  ...
  $query = "select count(fg.gid) as ftpnum from ftp_group fg,domain_aliasses d where d.alias_id = ? and fg.groupname=d.alias_name";
  $rs = exec_query($sql, $query, array($als_id));
