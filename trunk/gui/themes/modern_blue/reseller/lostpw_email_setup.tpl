    ...
    <td align="right" background="{THEME_COLOR_PATH}/images/icons/icon_bcgr.gif" class="menu"><a href="../index.php" onMouseOver="MM_swapImage('logout','','{THEME_COLOR_PATH}/images/icons/logout_a.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="{THEME_COLOR_PATH}/images/icons/logout.gif" name="logout" width="36" height="36" border="0" id="logout"></a></td>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<form action="lostpw_email_setup.php" method="post" name="lostpw_email" ID="lostpw_email">
            ...
            <table width="100%" cellpadding="5" cellspacing="5">
              ...
              <tr>
                ...
                <td WIDTH="300" class="content"> 
                  <input name="auto_subject1" type="text" class="textinput" ID="auto_subject1" style="width:270px" value="{SUBJECT_VALUE1}">
                </td>
                <td class="content"><input type="text" name="auto_subject2" value="{SUBJECT_VALUE2}" style="width:270px" class="textinput"></td>
              </tr>
              <tr>
                <td>&nbsp;</td> 
                <td class="content2" width="200">{TR_MESSAGE}</td>
                <td class="content"> 
                  <textarea name="auto_message1" rows="8" class="textinput2" ID="auto_message1" style="width:270px">{MESSAGE_VALUE1}</textarea>
                </td>
                <td class="content"><textarea name="auto_message2" rows="8" class="textinput2" ID="auto_message2" style="width:270px">{MESSAGE_VALUE2}</textarea></td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td> 
            ...
            <input type="hidden" name="uaction" value="lostpw_email_setup">
           </form>
			</td>
            <td>&nbsp;</td>
          </tr>
